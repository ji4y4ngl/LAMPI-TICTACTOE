...
class StartScreen(Screen):
    ...
    def _build_create_popup(self):
        ...
        msg = {'player1': device_id,
            'player2': associated_player2,
            'a_code': self.game_association_code,
            'client': MQTT_CLIENT_ID}
        mqtt.publish(TTT_TOPIC_ASSOCIATE,
    ...
    def update_create_popup(self, instance):
        ...
        instance.content.text = ("Associated with \n {}"
                                 .format(player2))
...
class LampiApp(App):
    ...
    def receive_associated_game(self, client, userdata, message):
        ...
        if self._associated_to_game != new_associated['associated']:
            if not new_associated['associated']:
                startScr.game_association_code = new_associated['code']
            else:
                startScr.game_association_code = None
            self._associated_to_game = new_associated['associated']
    ...
    def _poll_associated(self, dt):
        ...
        self.device_associated_to_game = self.startScr._associated_to_game
